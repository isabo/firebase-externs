 ...
 * @param {!function(Error, {auth:Object, expires:number})=} onComplete
 * @param {!function(!Error)=} onCancel
 * @deprecated
 */
...
/**
 * @param {string} authToken
 * @param {!function(Error, Firebase.AuthCallbackData)} onComplete
 ...
 * @param {!function(Error, boolean, !Firebase.DataSnapshot)=} onComplete
...
/**
 * @param {!Firebase.AuthPasswordCredentials} credentials
 * @param {!function(Error, {uid:string})} onComplete
 */
